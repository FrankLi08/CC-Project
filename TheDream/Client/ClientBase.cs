...
namespace TheDream.Client
{
    public abstract class ClientBase
    {
        ...
        protected async Task<TResponse> GetJsonDecodeContent<TResponse, TContentResponse>(string uri, params KeyValuePair<string, string>[] requestParameters)
        ...
        protected static async Task<TResponse> DecodeJsonResponse<TResponse, TDecode>(HttpResponseMessage apiResponse) where TResponse : ApiResponse<TDecode>, new()
        {
